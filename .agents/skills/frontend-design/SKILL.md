...
description: Guide for creating distinctive and opinionated visual identities, UI/UX, typography, layout, and copywriting. Use this before implementation to plan the visual identity.
---
# Frontend Design
...
- a warm cream background (near #F4F1EA) with a high-contrast serif display and a terracotta or warm-clay accent.
...
- the SaaS-card kit: content chopped into identical rounded cards, one border-radius on everything regardless of hierarchy, the same soft grey shadow.
- template chrome that appears whatever the subject: a tracked-out ALL-CAPS eyebrow label above every heading.
...
Then review that plan against the brief before building. Only after you've confirmed the relative uniqueness of your design plan should you start to write the code, following the revised plan.
